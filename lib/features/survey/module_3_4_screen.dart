...
//
// class Module34Screen extends StatefulWidget {
//   const Module34Screen({super.key});
//
//   @override
//   State<Module34Screen> createState() => _Module34ScreenState();
// }
//
// class _Module34ScreenState extends State<Module34Screen> {
...
//                                     onChanged: (v) {
//                                       member.productionQuantity = v.isEmpty ? null : double.parse(v);
//                                       surveyProvider.updatedData();
//                                     },
...
//                               onChanged: (v) {
//                                 member.otherSourceQuantity = v.isEmpty ? null : double.parse(v);
//                                 surveyProvider.updatedData();
//                               },
...
//                     if (member.otherStaticModel!.id == '9' && surveyProvider.selected9_peyaj.isNotEmpty) ...buildLossSection(surveyProvider, 9, surveyProvider.selected9_peyaj, member, isPartOne, part),
...
//                     if (member.otherStaticModel!.id == '12' && surveyProvider.selected12_Cingri.isNotEmpty) ...buildLossSection(surveyProvider, 12, surveyProvider.selected12_Cingri, member, isPartOne, part),
...
//                     if (member.otherStaticModel!.id == '14' && surveyProvider.selected14_hen.isNotEmpty) ...buildLossSection(surveyProvider, 14, surveyProvider.selected14_hen, member, isPartOne, part),
//
...
//                                 buildNextButton(
//                                   () {
//                                     surveyProvider.updateForm4Data(part, (isPartOne ? member.computedTotalQuantity : member.computedTotalQuantityPartTwo));
...
//     final double totalQty = isPartOne ? member.computedTotalQuantity ?? 0 : member.computedTotalQuantityPartTwo ?? 0;
//     if (lossQty > totalQty) {
...
//     }
//     if ((member.otherStaticModel!.id == '9') && surveyProvider.selected9_peyaj.isNotEmpty) {
//       return checkStatus(surveyProvider.selected9_peyaj, member);
//     }
...
//     }
//     if ((member.otherStaticModel!.id == '12') && surveyProvider.selected12_Cingri.isNotEmpty) {
//       return checkStatus(surveyProvider.selected12_Cingri, member);
//     }
...
//     }
//     if ((member.otherStaticModel!.id == '14') && surveyProvider.selected14_hen.isNotEmpty) {
//       return checkStatus(surveyProvider.selected14_hen, member);
//     }
//
//     return true;
//   }
...
//   Widget itemWidgetBody(SurveyProvider surveyProvider, int type, List<Module4Model> dataList, int part, var member, bool isPartOne) {
//     return Container(
//       width: double.infinity,
//       padding: EdgeInsets.all(16.r),
//       decoration: BoxDecoration(
...
//               } else {
//                 final double lossQty = dataList.fold(0, (sum, item) => sum + (item.lossAmountPerKg ?? 0));
//                 print("Loss Qty for type $type: $lossQty");
...
//               if (parsed == null) {
//                 // Invalid input - show toast
//                 Fluttertoast.showToast(msg: 'অবৈধ ইনপুট', toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.BOTTOM, backgroundColor: Colors.red, textColor: Colors.white, fontSize: 14.0);
...
//               }
//
//               final List<Module4Model> list = _getModuleListByType(type, surveyProvider);
...
//
//               if (remaining <= 0) {
//                 Fluttertoast.showToast(msg: 'অধিক ক্ষতির জন্য কোনো খালি পরিমাণ আর নেই', toastLength: Toast.LENGTH_LONG, gravity: ToastGravity.BOTTOM, backgroundColor: Colors.red, textColor: Colors.white, fontSize: 14.0);
//                 WidgetsBinding.instance.addPostFrameCallback((_) {
//                   final prev = moduleData.lossAmountPerKg?.toString() ?? '';
//                   if (moduleData.lossQuantityPerKgController.text != prev) {
//                     moduleData.lossQuantityPerKgController.value = TextEditingValue(
...
//
//               if (parsed > remaining) {
//                 Fluttertoast.showToast(msg: 'শুধু $remaining কেজি পর্যন্ত দিয়েই এটা পূরণ করা যাবে', toastLength: Toast.LENGTH_LONG, gravity: ToastGravity.BOTTOM, backgroundColor: Colors.red, textColor: Colors.white, fontSize: 14.0);
//                 WidgetsBinding.instance.addPostFrameCallback((_) {
//                   final prev = moduleData.lossAmountPerKg?.toString() ?? '';
//                   if (moduleData.lossQuantityPerKgController.text != prev) {
//                     moduleData.lossQuantityPerKgController.value = TextEditingValue(
...
//               }
//
//               // Valid input - clear error and update values
//               if (_lossErrors[key] != null) setState(() => _lossErrors[key] = null);
//               moduleData.lossAmountPerKg = parsed;
//
//               if (part == 1) {
//                 moduleData.lossWithTotalProducersPerKg = parsed + net;
//               } else {
//                 moduleData.lossWithTotalProducersPerKgMinus = net - parsed;
//               }
//
//               surveyProvider.updatedData();
//             },
...
//             leftExpandedValue: 1,
//             rightExpandedValue: 1,
//             externalErrorText: _lossErrors[key],
//             isMandatory: true,
//             mandatoryMessage: _lossErrors[key],
//           ),
//
//           buildReadOnlyField(
//             'ক্ষতির হার (%)',
...
//             labelBuilder: (item) => item.description,
//           ),
//           moduleData.lossAmountPerKg == null || moduleData.lossAmountPerKg! <= 0|| moduleData.lossAmountPerKg! == 0.0 ? spaceZero : spaceHeight10,
//           // Text("shshhs ${ moduleData.lossAmountPerKg??"0"}"),
//           moduleData.lossAmountPerKg == null || moduleData.lossAmountPerKg! <= 0|| moduleData.lossAmountPerKg! == 0.0 ? spaceZero : labelText('ক্ষতির প্রধান কারণ'),
//           moduleData.lossAmountPerKg == null || moduleData.lossAmountPerKg! <= 0|| moduleData.lossAmountPerKg! == 0.0 ? spaceZero
//               : DynamicRadioList(
...
//   }
//
//   List<Module4Model> _getModuleListByType(int type, SurveyProvider surveyProvider) {
//     switch (type) {
//       case 1:
//         return surveyProvider.selected1Amon;
//       case 2:
//         return surveyProvider.selected2Boro;
//       case 3:
//         return surveyProvider.selected3Aus;
//       case 4:
//         return surveyProvider.selected4Dhan;
//       case 5:
//         return surveyProvider.selected5Cal;
//       case 6:
//         return surveyProvider.selected6Mosur;
//       case 7:
//         return surveyProvider.selected7Mango;
//       case 8:
//         return surveyProvider.selected8_alu;
//       case 9:
//         return surveyProvider.selected9_peyaj;
//       case 10:
//         return surveyProvider.selected10Sorisha;
//       case 11:
//         return surveyProvider.selected11_Carp;
//       case 12:
//         return surveyProvider.selected12_Cingri;
//       case 13:
//         return surveyProvider.selected13_cow;
//       case 14:
//         return surveyProvider.selected14_hen;
//       default:
//         return [];
//     }
//   }
...
//     final double totalQuantity = dataList.isNotEmpty ? (dataList.first.lossAmountPerKg ?? 0.0) : 0.0;
//     return [
...
//       ),
//       SliverToBoxAdapter(
//         child: Padding(padding: EdgeInsets.only(left: 20, right: 20, top: 5, bottom: 10), child: itemWidgetBody(surveyProvider, type, dataList, part, member, isPartOne)),
//       ),
//     ];
//   }
// }
