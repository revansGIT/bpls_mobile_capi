...
class AluFoodLossScreen extends StatefulWidget {
  const AluFoodLossScreen({super.key});

  @override
  State<AluFoodLossScreen> createState() => _AluFoodLossScreenState();
}

class _AluFoodLossScreenState extends State<AluFoodLossScreen> {
  ...
  void _initializeLossKeys() {
    var module4List = [];
    module4List = providerAlu.member.module4ModelList ?? [];
