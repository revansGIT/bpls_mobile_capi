...
class CingriFoodLossScreen extends StatefulWidget {
  const CingriFoodLossScreen({super.key});

  @override
  State<CingriFoodLossScreen> createState() => _CingriFoodLossScreenState();
}

class _CingriFoodLossScreenState extends State<CingriFoodLossScreen> {
  ...
  void _initializeLossKeys() {
    var module4List = [];
    module4List = providerCingri.member.module4ModelList ?? [];
  ...
  Widget build(BuildContext context) {
    ...
    String cropName = 'চিংড়ি';

    String title = '$cropName (গত এক বছরে)';

    return Consumer<CingriProvider>(builder: (context,provider,child)=>Scaffold(
      appBar: AppBar(
        leading: IconButton(
          onPressed: () {
