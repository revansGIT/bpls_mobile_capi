...
class SorishaFoodLossScreen extends StatefulWidget {
  const SorishaFoodLossScreen({super.key});

  @override
  State<SorishaFoodLossScreen> createState() => _SorishaFoodLossScreenState();
}

class _SorishaFoodLossScreenState extends State<SorishaFoodLossScreen> {
  ...
  void _initializeLossKeys() {
    var module4List = [];
    module4List = providerSorisha.member.module4ModelList ?? [];
  ...
  Widget build(BuildContext context) {
    ...
    // SorishaProvider provider = Provider.of<SorishaProvider>(context);
    String cropName = 'সরিষা';

    String title = '$cropName (গত এক বছরে)';

    return Consumer<SorishaProvider>(
