...
class PeyajFoodLossScreen extends StatefulWidget {

  const PeyajFoodLossScreen({super.key});

  @override
  State<PeyajFoodLossScreen> createState() => _PeyajFoodLossScreenState();
}

class _PeyajFoodLossScreenState extends State<PeyajFoodLossScreen> {
  ...
  void _initializeLossKeys() {
    ...
    var module4List = [];
    module4List = providerPeyaj.member.module4ModelList ?? [];
  ...
  Widget build(BuildContext context) {
    ...
    String cropName = 'পেঁয়াজ';
    String title = '$cropName (গত এক বছরে)';

    return Consumer<PeyajProvider>(builder: (context,provider,child)=>Scaffold(
      appBar: AppBar(
        leading: IconButton(
          onPressed: () {
                                      ...
                                      onChanged: (v) {
                                        ...
                                        if (!isValid) {
                                          WidgetsBinding.instance.addPostFrameCallback((_) {
                                            ...
                                            //   moduleData.lossQuantityPerKgFocusNode,
                                            // );
                                          });
                                          return;
                                        }
