...
class BoroDhanFoodLossScreen extends StatefulWidget {

  const BoroDhanFoodLossScreen({super.key});

  @override
  State<BoroDhanFoodLossScreen> createState() => _BoroDhanFoodLossScreenState();
}

class _BoroDhanFoodLossScreenState extends State<BoroDhanFoodLossScreen> {
  ...
  void _initializeLossKeys() {
    ...
    var module4List = [];
    module4List = providerBoroDhan.member.module4ModelList ?? [];
  ...
  Widget build(BuildContext context) {
    ...
    String cropName = 'বোরো ধান';

    String title = '$cropName (গত এক বছরে)';

    return Consumer<BoroDhanProvider>(builder: (context,provider,child)=>Scaffold(
      appBar: AppBar(
        leading: IconButton(
          onPressed: () {
