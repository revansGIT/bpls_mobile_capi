...
class CowFoodLossScreen extends StatefulWidget {

  const CowFoodLossScreen({super.key});

  @override
  State<CowFoodLossScreen> createState() => _CowFoodLossScreenState();
}

class _CowFoodLossScreenState extends State<CowFoodLossScreen> {
  ...
  void _initializeLossKeys() {
    var module4List = [];
    module4List = providerCow.member.module4ModelList ?? [];
  ...
  Widget build(BuildContext context) {
    ...
    String cropName = 'গরুর মাংস';

    String title = '$cropName (গত এক বছরে)';

    return Consumer<CowProvider>(builder: (context,provider,child)=>Scaffold(
      appBar: AppBar(
        leading: IconButton(
          onPressed: () {
