...
class MosurFoodLossScreen extends StatefulWidget {

  const MosurFoodLossScreen({super.key});

  @override
  State<MosurFoodLossScreen> createState() => _MosurFoodLossScreenState();
}

class _MosurFoodLossScreenState extends State<MosurFoodLossScreen> {
  ...
  void _initializeLossKeys() {
    var module4List = [];
    module4List = providerMosur.member.module4ModelList ?? [];
  ...
  Widget build(BuildContext context) {
    ...
    String cropName = 'মসুর ডাল';
    String title = '$cropName (গত এক বছরে)';

    return Consumer<MosurProvider>(builder: (context,provider,child)=>Scaffold(
      appBar: AppBar(
        leading: IconButton(
          onPressed: () {
