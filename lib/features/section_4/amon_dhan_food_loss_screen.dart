...
class AmonDhanFoodLossScreen extends StatefulWidget {
  const AmonDhanFoodLossScreen({super.key});

  @override
  State<AmonDhanFoodLossScreen> createState() => _AmonDhanFoodLossScreenState();
}

class _AmonDhanFoodLossScreenState extends State<AmonDhanFoodLossScreen> {
  ...
  void _initializeLossKeys() {
    var module4List = [];
    module4List = providerAmonDhan.member.module4ModelList ?? [];
  ...
  Widget build(BuildContext context) {
    ...
    String cropName = 'আমন ধান';

    String title = '$cropName (গত এক বছরে)';

    return Consumer<AmonDhanProvider>(builder: (context,provider,child)=>Scaffold(
      appBar: AppBar(
        leading: IconButton(
          onPressed: () {
