...
class AusDhanFoodLossScreen extends StatefulWidget {
  const AusDhanFoodLossScreen({super.key});

  @override
  State<AusDhanFoodLossScreen> createState() => _AusDhanFoodLossScreenState();
}

class _AusDhanFoodLossScreenState extends State<AusDhanFoodLossScreen> {
  ...
  void _initializeLossKeys() {
    var module4List = [];
    module4List = providerAusDhan.member.module4ModelList ?? [];
  ...
  Widget build(BuildContext context) {
    ...
    String cropName = 'আউস ধান';

    String title = '$cropName (গত এক বছরে)';

    return Consumer<AusDhanProvider>(builder: (context,provider,child)=>Scaffold(
      appBar: AppBar(
        leading: IconButton(
          onPressed: () {
