...
class CalFoodLossScreen extends StatefulWidget {
  const CalFoodLossScreen({super.key});

  @override
  State<CalFoodLossScreen> createState() => _CalFoodLossScreenState();
}

class _CalFoodLossScreenState extends State<CalFoodLossScreen> {
  ...
  void _initializeLossKeys() {
    var module4List = [];
    module4List = providerCal.member.module4ModelList ?? [];
  ...
  Widget build(BuildContext context) {
    ...
    // CalProvider provider = Provider.of<CalProvider>(context);
    String cropName = 'চাল';
