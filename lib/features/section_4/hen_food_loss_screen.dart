...
class HenFoodLossScreen extends StatefulWidget {
  const HenFoodLossScreen({super.key});

  @override
  State<HenFoodLossScreen> createState() => _HenFoodLossScreenState();
}

class _HenFoodLossScreenState extends State<HenFoodLossScreen> {
  ...
  void _initializeLossKeys() {
    var module4List = [];
    module4List = providerHen.member.module4ModelList ?? [];
  ...
  Widget build(BuildContext context) {
    ...
    String cropName = 'মুরগির মাংস (পোল্ট্রি/ব্রয়লারসহ সব ধরনের মুরগী)';

    String title = '$cropName (গত এক বছরে)';

    return Consumer<HenProvider>(builder: (context,provider,child)=>Scaffold(
      appBar: AppBar(
        leading: IconButton(
          onPressed: () {
