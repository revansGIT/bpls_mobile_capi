...
class SorishaProvider with ChangeNotifier {
  ...
  final Map<int, Map<String, dynamic>> _partConfigMap = {
    1: {
      'count': 11,
      'items': [
        {'typeList': 'lossReasonList1', 'title': 'ফসল তোলা/কাটা/কর্তন/আঁটি বাঁধাই পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonList2', 'title': 'মাঠ থেকে বাড়ি বা মাড়াই এর স্থানে আনার মধ্যবর্তী পর্যায়ে পরিবহণ জনিত ক্ষতি'},
        {'typeList': 'lossReasonList3', 'title': 'ফসল মাড়াই পর্যায়ে ক্ষতি (বাড়িতে/জমিতে)'},
        {'typeList': 'lossReasonList4', 'title': 'পরিষ্কার করা/উইনো (ঝাড়া) করা পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonList5', 'title': 'সিদ্ধ/শুকানো পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonList6', 'title': 'ওজন করার পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonList7', 'title': 'প্যাকেজিং পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonList8', 'title': 'লোড-আনলোড পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonList9', 'title': 'পরিবহন/হস্তান্তর পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonList10', 'title': 'স্টোরেজ পর্যায়ে ক্ষতি'},
    ...
    4: {
      'count': 12,
      'items': [
        {'typeList': 'lossReasonListPartFour1', 'title': 'ক্রয়ের স্থান থেকে অটো/চাতাল মিলে পরিবহন পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonListPartFour2', 'title': 'পরিষ্কার করা/উইনো করা (ঝাড়া) পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonListPartFour3', 'title': 'সিদ্ধ/শুকানো পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonListPartFour4', 'title': 'প্যাকেজিং/রি-প্যাকেজিং পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonListPartFour5', 'title': 'স্টোরেজ পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonListPartFour6', 'title': 'ছাটাই/ভাঙ্গানো (Husking) পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonListPartFour7', 'title': 'পলিশিংকরণ পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonListPartFour8', 'title': 'বাছাইকরণ/গ্রেডিং পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonListPartFour9', 'title': 'লোড-আনলোড পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonListPartFour10', 'title': 'অটো/চাতাল মিল থেকে বাজারজাতকরণে পরিবহন পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonListPartFour11', 'title': 'স্টোরেজ পর্যায়ে ক্ষতি'},
        {'typeList': 'lossReasonList96', 'title': 'অন্যান্য ক্ষতি (উল্লেখ করুন)'},
      ],
    },
    5: {
